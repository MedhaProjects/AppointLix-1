    ...
    return userData ? (
        <div className='max-w-lg flex flex-col gap-2 text-sm pt-5'>
            ...
            <div className='mt-10'>
                ...
                {isEdit
                    ? <button onClick={updateUserProfileData} className='border border-primary px-8 py-2 rounded-full hover:bg-[#8b24b9]                  hover:text-white transition-all'>Save information</button>
                    : <button onClick={() => setIsEdit(true)} className='border border-primary px-8 py-2 rounded-full hover:bg-[#8b24b9]                  hover:text-white transition-all'>Edit</button>
                }
